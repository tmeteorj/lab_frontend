...
<body>
		<div  align="left" style="height: 100%">
			<h1>
				配置 <small>图表折线图展示</small>
			</h1>
			<div class="hero-unit" contenteditable="true" >
			
				<form name="datasetform" method="post" action="http://127.0.0.1:8081/jxc/index.php/Visualization/chartline_selectmatadata/">
				...
				<div style="display:block;">
					<form name="matadatasetform" method="post" action="http://127.0.0.1:8081/jxc/index.php/Visualization/chartline_selectmap/">
					
					<legend contenteditable="true">请选择折线图</legend>
					<div class="control-group">
					...
					<div class="control-group">
						...
						<div class="controls">
							<select id="mp" name="mp" style="width: 100%;">
								...
								<option value="8">Chart.js</option>
									 
										
								<option value="9">ECharts</option>
																</select>
